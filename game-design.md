...
Two gears, one chain, a whole jungle to maw down. Swing your saw-bot island-to-island, slice grass, dodge obstacles, climb 20 hand-tuned stages.
...
|---|---|---|
| Swap anchor / launch the chain | Tap anywhere | Click anywhere · Space |
| Adjust live chain length | HUD `+1` / `-1` buttons | Mouse wheel · HUD `+1` / `-1` |
| Open upgrades / achievements | HUD bottom-right buttons | Same |
| Continue / dismiss a reward | Tap | Click · Space · Enter |
| Cheat: jump to stage | — | Type `cmarc` to enable debug, then `ctrl+shift+N` for stage select |
